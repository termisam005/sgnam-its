...
const TreeAccordComponent = ({ children, accordClass, treeTopClass, checkClass, txt, show }) => {
    ...
    return (
        <div onClick={toggleAccord} className={accordClass}>
           <div className={treeTopClass}>
                <button className={accordion? 'accordion_toggle h12' : 'accordion_toggle h12 on'}>
