            ...
            <div className={toggleInd? 'indi_conts del':'indi_conts'}>
                <dl class="check_dl">
                    ...
                    <dd>
                        ...
                        {/* <button type='button' className={rangeTab === 3? "btn_analy on" : "btn_analy"} onClick={() => tabRange(3)}>최소제어그룹</button> */}
                    </dd>
                </dl>
                <dl class="check_dl">
                    <dt>요일</dt>
                ...
                <section className='status_analysis'>
                    <div className='dflx_ac_jbet col_gap4'>
                        ...
                        <ImgComponent className={'w16 img_dark'} src={'arrow_right_2line_sky_16.svg'} />
                        <ImgComponent className={'w16 img_light'} src={'arrow_right_2line_blue_16.svg'} />
