...
const FnbSearchBar = ({ children }) => {
    ...
    return (
        <div className={srchBar? 'fnb_search_bar on' : 'fnb_search_bar'}>
            {children}
            <ButtonWithComponent onClick={toggleSrch} className={srchBar? 'w40 selected btn_icon icon_ffb' : 'w40 btn_icon icon_ffb'}>
            ...
            <div className="search_bar_input">
                <div className="dflx_ac gap_8">
                    ...
                    <SearchWordComponent lineClass={'srch_line'} zoneClass={'put_zone w176'} type={'text'} placeholder={'Search'} />
                </div>
            </div>
        </div>
    );
