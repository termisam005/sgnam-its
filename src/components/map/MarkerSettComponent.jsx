            ...
            <div className="tooltip_parents">
                <MarkerComponent onClick={toggleMark} className={markStatus? 'marker mk56 on' : 'marker mk56'}>
                    ...
                    <div className="img_light">
                        <ImgComponent className={'img_off'} src={'car_accident_light_56.svg'} />
                        <ImgComponent className={'img_selected'} src={'car_accident_selected_light_56.svg'} />
                    </div>
                </MarkerComponent>
                <InfoWindowComponent className={markStatus? 'infowindow_box on top dpblock' : 'infowindow_box on top'} title={'시청역사거리 추돌사고'}
                    ...
                    <LabelComponent className={'label_tag bg_grey fs_11'} txt={'사고'} />
