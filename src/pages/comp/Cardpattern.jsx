                        ...
                        <div className="grid_column4 col_gap30">
                            <div className='w280'>
                                <TmboxComponent className={'tmbox'}>
                                    ...
                                    <dl className="tm_dl">
                                        <dt>
                                            <p className='fs_bold'>[생생뉴스] 부천시청 앞 추출사고</p>
                                        </dt>
                                        <dd>
                            ...
                            <div className='w280'>
                                ...
                                <div className="indi_share">
                                    ...
                                    <IndidlComponent dlClass={'indi_dl third green'} title={'원활'} result={'208'} />
                                    <IndidlComponent dlClass={'indi_dl third red'} title={'정체'} result={'19'} />
                                </div>
                                <div className="indi_share">
                                ...
                                <div className="m-t-30">
                                    <div className="tab_line m-b-8">
                                        <ButtonComponent className={'btn_line1 btn_ss selected'} txt={'오늘'} />
                                        <ButtonComponent className={'btn_line1 btn_ss'} txt={'내일'} />
                                    </div>
                            ...
                            <div className="bott_info chart">
                                <SmarttopComponent smartClass={'smart_top'} labelClass={'label_tag bg_ui_blue_more fs_12_medium'}
