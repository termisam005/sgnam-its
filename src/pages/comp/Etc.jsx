...
import ProgressIndicates from '../../components/etc/ProgressIndicates'
                ...
                <div className='guide_center'>
                    ...
                    <article className='Gr_contents'>
                        <div className='comp_top flex_wrap'>
                            <h2>Label</h2>
                            <p className='w-100 m-t-12'>별도의 기능 없이 정보를 표시하는 용도</p>
                        </div>
                        <section className='comp_conts'>
                            <dl className='comp_dl flex_wrap'>
                                <dt className='comp_dt w-100'>Box</dt>
                                <dd className='comp_dd'>
                                    <div className='compline m-t-20'>
                                        <p className='comp_size'>Rainbow</p>
                                        <div className='components m-l-36'>
                                    ...
                                    <div className='compline m-t-30'>
                                        <p className='comp_size'>Grade</p>
                                        <div className='components m-l-36'>
                                            <LabelComponent className='label_tag grade_color02 fs_12_medium' txt='직행' />
                                            <LabelComponent className='label_tag gradeko_color02 fs_12_medium' txt='좌석' />
                                            <LabelComponent className='label_tag grade_color08 fs_12_medium' txt='일반' />
                                            <LabelComponent className='label_tag grade_color08 fs_12_medium' txt='저상' />
                                            <LabelComponent className='label_tag grade_color06 fs_12_medium' txt='마을' />
                                        </div>
                                    </div>
                                </dd>
                            </dl>
                            ...
                            <dl className='comp_dl flex_wrap'>
                                <dt className='comp_dt w-100'>Ellipse</dt>
                                <dd className='comp_dd'>
                                    <div className='compline m-t-20'>
                                        <p className='comp_size'>Rainbow</p>
                                        <div className='components m-l-36'>
                            ...
                            <dl className='comp_dl flex_wrap m-t-80'>
                                <dt className='comp_dt w-100'>Number</dt>
                                <dd className='comp_dd m-t-20'>
                                    <div className='compline'>
                                        <div className='dashed_box p-20 gap_20 dflx_ac_jcent'>
                                            <ButtonComponent type='button' className='bg_ui_blue number_default' txt='1'>
                                            </ButtonComponent>
                            ...
                            <dl className='comp_dl flex_wrap m-t-40'>
                                <dt className='comp_dt w-100'>Text</dt>
                                <dd className='comp_dd'>
                                    <div className='compline p-40 bg_grey06 dflx gap_60'>
                                        <div className='fs_14_medium'>지역명</div>
                                        <div className='fs_20_medium bg_default h28 pd-2-12 dflx_ac gap_6'>
                                            <p><span className='fc_primary'>스마트교차로</span> </p>
                                            <p>vs</p>
                                            <p className='fc_green'>예측 데이터</p>
                                        </div>                                    
                                        <div className='fs_20_medium bg_ui_sky_10 pd-20-24 dflx_ac gap_40'>
                    ...
                    <article className='Gr_contents'>
                        ...
                        <div className='dflx_as p-l-20 p-r-20'>
                            <span className=''>Loading Spinner</span>
                            <span className='m-l-200'>Progress bars</span>
                        </div>
                        <section className='comp_conts dflx_as'>
                            <div className='dashed_box dflx_as p-20 m-t-20'>
                                <div className='dflx gap_60'>
                                    <div>
                                        <p className="fs_12 m-b-30">Large(120px)</p>
                                        <ImgComponent className='spin_animation' src={'ring_large.png'} alt='원형 로딩 바' />
                                    </div>
                                    <div>
                                        <p className="fs_12 m-b-60">small(40px)</p>
                                        <ImgComponent className='spin_animation' src={'ring_small.png'} alt='원형 로딩 바' />
                                    </div>
                                </div>
                                <ProgressIndicates className='m-l-100 as_center' progress='progress_bar w320 h4'></ProgressIndicates>
                            </div>                     
                        </section>
                    </article>
                </div>
