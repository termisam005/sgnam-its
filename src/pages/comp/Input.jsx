                ...
                <div className='guide_center width1720'>
                    ...
                    <article className="Gr_contents m-t-100">
                        ...
                        <dl className="comp_dl">
                            ...
                            <dd className="comp_dd">
                                ...
                                <div className="compline col_gap20 m-t-25">
                                    <InputZoneComponent zoneClass={'put_zone w320'} type={'text'} placeholder={'아이디'} value={'Highlight'} inputClass={'wrput read_light'} readonly 
                                    deleteClass={deletor? 'put_check put_delete dflx' : 'put_check put_delete'} />
                                    <div className="w320"></div>
                                    <InputZoneComponent zoneClass={'put_zone w320'} type={'text'} placeholder={'아이디'} value={'Highlight'} inputClass={'wrput large read_light'} readonly 
                                    deleteClass={deletor? 'put_check put_delete dflx' : 'put_check put_delete'} />
                                </div>
                                <div className="compline col_gap20 m-t-25">
                        ...
                        <dl className="comp_dl">
                            ...
                            <dd className="comp_dd">    
                                <div className="compline col_gap20">
                                    <p className="comp_size as_start m-r-40 p-t-20">Input</p>
                    ...
                    <article className="Gr_contents">
                        ...
                        <section className="comp_conts">
                            ...
                            <div class="dflx_ac col_gap48 dashed_box p-20 m-b-50 m-r-40">
                                <EditorTextComponent />
                                <EditorVms1Component />
                            </div>
                        </section>
