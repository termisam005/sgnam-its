            ...
            <div className='guide_wrap'>
                ...
                <div className='guide_center width1720'>
                    ...
                    <article className="Gr_contents">
                        ...
                        <section className="comp_conts dflx">
                                ...
                                <div className="dflx_column m-t-50">
                                    <div className="dflx">
                                        <div className="dflx_column gap_20 relative">
                                            ...
                                            <div className="dflx_ac col_gap64 m-l-100">
                                                <div className='m-l-10'>
                                                    <ImgComponent src={'plus_line.svg'} />
                                                </div>
                                                <div>
                                                    <ImgComponent src={'plus_line.svg'} />
                                                </div>
                            ...
                            <div className="m-l-100">
                                <div className="m-t-50 map_frame">
                    ...
                    <article className='Gr_contents'>
                        ...
                        <section className='comp_conts dflx'>
                            <div>
                                <div className='fs_bold m-t-20'>Basic</div>
                                <div className='dflx_column m-t-80'>
                                    <div className='dflx_as'>
                                        ...
                                        <div className='dflx'>
                                            <div className='dflx_column gap_20 relative'>
                                                ...
                                                <div className='dflx_ac gap_20'>
                                                    <ButtonWithComponent type={'button'} className={'marker mk48 on cctv'} onClick={''}>
                                                        <ImgComponent className='img_off' src={'cctv_normal_32.svg'} />
                                                        <ImgComponent className='img_selected' src={'cctv_normal_selected_48.svg'} />
                                                    </ButtonWithComponent>
                                                    <ButtonWithComponent type={'button'} className={'marker mk48 on weather'} onClick={''}>
                                                        <ImgComponent className='img_off' src={'weather_center_48.svg'} />
                                                        <ImgComponent className='img_selected' src={'weather_center_selected_48.svg'} />
                                                    </ButtonWithComponent>
                                                </div>
                                        ...
                                        <div className='dflx m-l-60'>
                                            <div className='dflx_column gap_20 relative'>
                                                ...
                                                <div className='dflx_ac gap_20'>
                                                    <ButtonWithComponent type={'button'} className={'marker mk48 on bjus'} onClick={''}>
                                                        <ImgComponent className='img_off' src={'bus_green_basic_32.svg'} />
                                                        <ImgComponent className='img_selected' src={'bus_green_selected_48.svg'} />
                                                    </ButtonWithComponent>
                                                    <ButtonWithComponent type={'button'} className={'marker mk48 on depart'} onClick={''}>
                                                        <ImgComponent className='img_off' src={'depart_48.svg'} />
                                                        <ImgComponent className='img_selected' src={'depart_selected_48.svg'} />
                                                    </ButtonWithComponent>
                                                </div>
                                    ...
                                    <div className='dflx_as'>
                                        <div className='dflx'>
                                            <div className='dflx_ac gap_40'>
                                                <ClusterComponent addedClass='circle16 bg_cluster border_black30' count=''>
                                                </ClusterComponent>
                                                <ClusterComponent addedClass='circle32 bg_cluster border_black30' count='+10'>
                                                    <ImgComponent className='w20' src={'cctv_fff_20.svg'} />
                                                </ClusterComponent>
                                                <ClusterComponent addedClass='circle48 bg_cluster border_black30' count='+100'>
                                                    <ImgComponent className='w36' src={'cctv_fff_20.svg'} />
                                                </ClusterComponent>
                                                <ClusterComponent addedClass='circle64 bg_cluster border_black30' count='+1,000'>
                            ...
                            <div className="dflx col_gap50">
                                <div className="">
                                    <div className="dflx_ac m-t-20">
                                        ...
                                        <div className="marker_departure w17 h17 m-l-40 bg_ui_sky_blue">
                                        </div>
                                ...
                                <div className="dflx col_gap30 m-l-100">
                                    <div>
                                        ...
                                        <div className="arrival_car pass_car">
                                            <ImgComponent src={'marker_arrival_car.svg'} />
                                        </div>
                                    </div>
                        ...
                        <section className="comp_conts">
                            ...
                            <div className="dflx_as">
                                <div className="m-t-40 dflx_as col_gap50">
                                    <ImagePopover className={'imgpopover_box front'} src={'image_popover_sample.png'} img>
                                    </ImagePopover>
                                    ...
                                    <div className='dflx_as m-t-32'>
                                        ...
                                        <div className="dflx_ac col_gap48">
                                            ...
                                            <ProgressComponent size='xmini'>
                                                <MapSliderTimeline top bottom small addedClass='map_time_line xsmall w72'>
                                                    <MapSliderLine addedClass='map_control_line' size='h12 w-40'>
                                                    </MapSliderLine>  
                                                </MapSliderTimeline>
                                            </ProgressComponent>   
                                        </div>                                        
                                    </div>
                                    <div className="dflx_ae gap_16 m-t-40">
                                        <div className='w160 fs_bold'>
                                            Usage
                                        </div>
                                        <DistanceComponent distClass={'map_scale'} distance={'5km'} />
                                        <ProgressComponent size='large'>
                                            <ProgressBox boxClass={'progress_box h40'} />
                                        </ProgressComponent>
                                    </div>   
                                ...
                                <section className='comp_conts dflx'>
                                    ...
                                    <div>
                                        ...
                                        <ListBlockComponent listClass={'btn_map_anchor dflx gap_8'}>
                                            <ButtonWithComponent type={'button'} className={'mapcontrol_btn'} onClick={''}>
                                        ...
                                        <ProgressComponent size='xmini' addedClass={'m-t-20'}>
                                            <MapSliderTimeline top bottom small addedClass='map_time_line xsmall w72'>
                                                <MapSliderLine addedClass='map_control_line' size='h12 w-40'>
                                                </MapSliderLine>  
                                            </MapSliderTimeline>
                        ...
                        <section className="comp_conts dflx col_gap60">
                            ...
                            <div className="card_box p-40 w-100">
                                ...
                                <div className='compline'>
                                    <span className="dflx_ac fs_20_bold bg_default fc_sky btn_s pd-2-12">최적화 분석</span>
                                </div>
                                
                                <div className='m-t-30 compline'>
                                    <span className="dflx_ac fs_20_bold bg_default fc_white100 btn_s pd-2-12">현황 분석</span>
                                </div>

                                <div className="compline m-t-30">
                                    <div className="dflx_ac gap_4 fs_20_bold bg_default btn_s pd-2-12">
                                        <span className="fc_sky">스마트교차로</span> 
                                        <span className="fc_white100">vs</span>
                                        <span className="fc_green">예측 데이터</span>
                                    </div>
                                </div>

                                <div className="compline">
                                    <div className="dflx_ac fs_20_bold bg_default btn_s pd-2-12">
                                        <span className="fc_sky">스마트교차로</span> 
                                        <span className="fc_yellow m-l-24">예측 시뮬레이션</span>
                                    </div>
                                </div>
                            </div>
                        </section>
                    ...
                    <article className='Gr_contents m-t-140'>                    
                                ...
                                <div className='relative m-l-20 w160 dflx'>
                                    <TooltipwindowComponent title='Title' addedClass='on'>
                                        <div className='dflx gap_4 m-b-10'>
                                            <span className='label_tag bg_grey40 fc_default fs_11'>Label</span>
                                            <span className='label_tag grade_color02 fs_11'>Label</span>
                                        </div>
                                        <p className='fc_grey60'>Lorem ipsum dolor sit amet consectetur. Ac fames sapien sed lacus cursus. Blandit viverra consequat nibh odio. Amet mauris fames </p>
                                        <ButtonComponent type='button' className='btn_primary btn_xs m-t-10 w-100' txt='Default'></ButtonComponent>
                                    </TooltipwindowComponent>                                    
                        ...
                        <section className='comp_conts m-t-100'>
                                    ...
                                    <div className='relative '>
                                        ...
                                        <div>
                                            ...
                                            <CustomOverlayComponent title='Title' addedClass='large'>
                                                ...
                                                <div className='fs_14_medium'>500</div>
                                                <div className='fs_14_medium'>50건</div>
                                    ...
                                    <div className='relative m-l-80'>
                                        ...
                                        <div>
                                            ...
                                            <CustomOverlayComponent title='Title' addedClass='small'>
                                                <div className='fc_yellow fs_12_medium'>25Km/h</div>
                                                <div className='fs_12_medium'>500</div>
                                                <div className='fs_12_medium'>50건</div>
                                            </CustomOverlayComponent>
                                        </div>
                                    </div>
                                </div>                                
                            ...
                            <div className='m-t-40'>
                                    <p className='w-100 fs_bold'>Usage</p>
                                    <div className='dflx p-t-60 p-l-40'>
                                        <div>
                                        ...
                                        <div className='m-l-140'>
                                            <div className='tooltip_parents m-t-120'>
                                                <ButtonWithComponent type={'button'} className={'marker mk48 on danger'} onClick={''}>
                                                ...
                                                <TooltipwindowComponent title='시청역사거리 추돌사고' addedClass='top on with_marker'>
                                                    <div className='dflx gap_4 m-b-10'>
                                                        <span className='label_tag fc_default bg_grey40 fs_11'>사고</span>
