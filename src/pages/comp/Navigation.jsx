        ...
        <div className='guide_wrap navigation'>
            ...
            <div className='guide_center width1720'>
                ...
                <article className="Gr_contents">
                    ...
                    <section className="comp_conts">
                        <div className="display_grid">
                            ...
                            <div className="gnb_box gap_30 h40 header_in m-t-60">
                        ...
                        <Header headerClass={'posrel'}>
                            <HeaderLeft>
                                ...
                                focus={handleFocus} open={selbox} close={closeBox} onChange={onChangeValue} placeholder={'개별차량 이동경로 시뮬레이션'} currentValue={'개별차량 이동경로 시뮬레이션'}>
                            ...
                            <HeaderRight>
                                <HdStatusComponent stausClass={'hd_status'} markClass={'time_mark20 clock'} textClass={'hd_text'} temper={'2022-05-26  수요일  14:10:40 '} slash={'/'} air={'0mm'} />
                        ...
                        <div className="dflx col_gap40">
                                                ...
                                                <div className=" gap_40 relative">
                                                    ...
                                                    <div className="dflx_column row_gap20">
                                                        <div className="h40 dflx_ac">
                                                            <ImgComponent className='img_dark' src={'gnb_logo.svg'} />
                                                            <ImgComponent className='img_light' src={'gnb_logo_light.svg'} />
                                                        </div>
                                                        <div className="h40 dflx_ac">
                                                            <ImgComponent className='img_dark' src={'gnb_logo_incheon.svg'} />
                                                        </div>
                                                        <div className="h40 dflx_ac">
                                                            <ImgComponent className='img_dark' src={'gnb_logo_bucheon.svg'} />
                                                        </div>    
                                                        <div className="h40 dflx_ac">
                            ...
                            <div>
                                ...
                                <div className="dflx_column black_box p-40 m-t-20">
                                    <div className="dflx_ac h-100">
                                        <p className="fs_14 fs_bold">Tab</p>
                                        <nav className='gnb posrel m-l-60'>
                                            <ul className='gap_30'>
                                                <li>
                                                    <Link to="#" className='on'>Selected</Link>
                                                </li>
                            ...
                            <div>
                                ...
                                <div className="dflx_column black_box p-20 m-t-20">
                                    <div className='dflx'>
                                        <p className="fs_14 fs_bold w100">Date & Time</p>
                                        <div className='m-l-80'>
                                            ...
                                            <div className="m-t-40">
                                                <HdtimeComponent stausClass={'hd_status'} markClass={'time_mark20 clock'} textClass={'hd_text'} date={'2022-05-26'} slash={'수요일'} time={'14:10:40'} />
                                            </div>
                                            <div className="m-t-40">
                                    ...
                                    <div className="dflx m-t-40">
                                        <p className="fs_14 fs_bold w100 m-t-10">Weather</p>
                                        <div className='m-l-80'>
                                            <HdStatusComponent stausClass={'hd_status'} markClass={'weath_mark32 some_snow_rain'} textClass={'hd_text'} 
                                            temper={'-23.0℃'} slash={'/'} air={'30mm'} />
                                            <div className="m-t-40">
                                    ...
                                    <div className="dflx m-t-40">
                                        <p className="fs_14 fs_bold w100">Profile menu</p>
                                        <div className="m-l-80">
                                            <ProfileComponent />
                                        </div>
                                    </div>
                ...
                <article className="Gr_contents m-t-100">
                    ...
                    <p className="fs_bold m-b-10">Fixed type</p>
                    <section className="comp_conts">
                        ...
                        <header className="posrel">
                            ...
                            <div className="lnb_box h40 dflx">
                                <div className="lnb_anchor gap_30">
                                    <Link to="#" className='on'>교통운영 모니터링</Link>
                    ...
                    <p className="fs_bold m-t-150 m-b-10">Dropdown type</p>
                    <section className="comp_conts">
                        <header className="posrel">
                            <article className='header_in'>
                                <HeaderLeft>
                                    <SelectBoxFillSelected wrapClass={'select_wrap w220'} placeholder={'placeholder'} />
                                </HeaderLeft>
                                <HeaderRight>
                            ...
                            <div className="lnb_box">
                                <div className="lnb_anchor gap_40 on">
                                    ...
                                    titleClass={'fs_14_medium'} title={'신호운영 모니터링'} subClass={'lnb_sub_anchor gap_20'}>
                                        <li>
                                    ...
                                    titleClass={'fs_14_medium '} title={'신호운영 분석'} subClass={'lnb_sub_anchor gap_20'}>
                                        <li>
                                            <Link to="#">교차로 분석</Link>
                                        </li>
                                        <li>
                                    ...
                                    titleClass={'fs_14_medium'} title={'시뮬레이션'} subClass={'lnb_sub_anchor gap_20'}>
                                        <li>
                                    ...
                                    titleClass={'fs_14_medium'} title={'신호 최적화'} subClass={'lnb_sub_anchor gap_20'}>
                                        <li>
                                    ...
                                    titleImgSrc={'gnb_analysis_fff_20.svg'} titleClass={'fs_14_medium'} title={'관리자 메뉴'} subClass={'lnb_sub_anchor gap_20'}>
                                        <li>
                    ...
                    <p className="fs_bold m-b-10" style={{marginTop:'300px'}}>Popup type</p>
                    ...
                    <header className="posrel">
                        ...
                        <div className="lnb_popup_content">
                            <div className="lnb_popup_title_bg dflx_ac_jbet">
                                <span className="fc_primary fs_20_bold">Popup title</span>
                                <ButtonWithComponent type="button">
                                    <ImgComponent className={'wh_to_dark'} src={'close_line_fff_24.svg'} />
                                </ButtonWithComponent>
                            </div>
                        </div>
                    </header>
                ...
                <article className="Gr_contents m-t-140">
                    ...
                    <p className="fs_bold m-b-10">Type 1</p>
                    <section className="comp_conts">
                        ...
                        <div className="dflx_jbet gap_40 m-t-60">
                            <div className="fnb_search_bar on">
                                <ButtonWithComponent className={'tooltip_parents btn_icon'}>
                                    <ImgComponent className={'img w24 op04'} src={'layer_fff_24.svg'} />
                                    <ImgComponent className={'img_on w24 '} src={'layer_sky_24.svg'} />
                                    <div className="tooltip_label">
                                        레이어
                    ...
                    <p className="fs_bold m-t-60 m-b-10">Type 2</p>
                    <section className="comp_conts">
                        <div className="relative">

                            <div className="footer_nav type2 p-l-20">
                            ...
                            <div className="black_box p-40 p-r-16 m-t-20">
                                ...
                                <div className="dflx m-t-20">
                                    <FnbSearchBar>
                                        ...
                                        <ButtonWithComponent className={'icon_ffb tooltip_parents btn_icon'}>
                                            <ImgComponent className={'img w24 op04'} src={'legend_fff_24.svg'} />
                                            <ImgComponent className={'img_on w24 '} src={'legend_sky_24.svg'} />
                                            <div className="tooltip_label">범례</div>
                                        </ButtonWithComponent>
