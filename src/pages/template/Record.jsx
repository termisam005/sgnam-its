                                    ...
                                    <div className='record_line'>
                                        ...
                                        <section className='record_dash'>
                                            <div className='dash_box vert'>
                                                ...
                                                <article className='vert_chart_wrap'>
                                                    <div className='vert_chart'>
                                                        <ImgComponent className={'img_chart img_dark'} src={'pie4.svg'} />
                                                        <ImgComponent className={'img_chart img_light'} src={'pie4_light.svg'} />
                                                    </div>
                                            ...
                                            <div className='dash_box vert'>
                                                ...
                                                <article className='vert_chart_wrap'>
                                                    <div className='vert_chart'>
                                                        <ImgComponent className={'img_chart img_dark'} src={'pie3.svg'} />
                                                        <ImgComponent className={'img_chart img_light'} src={'pie3_light.svg'} />
                                                    </div>
                                                ...
                                                <div className='types_contain'>
                                                    <article className='type_share'>
                                                        ...
                                                        <div className='types_lineb'>
                                                            <div className='types_chart'>
                                                                <ImgComponent className={'img_chart img_dark'} src={'event_pie_dark.svg'} />
                                                                <ImgComponent className={'img_chart img_light'} src={'event_pie_light.svg'} />
                                                            </div>
                                                    ...
                                                    <article className='type_share'>
                                                        <div className='smart_line grid3'>
                                                            ...
                                                            <SmartComponent labelClass={'label grade_color11'} labelWord={'정체발생'} number={'109'}>
                                                            </SmartComponent>
                                                        </div>
                                                    </article>
                                                </div>
